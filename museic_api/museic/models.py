...
class Song(models.Model):
    ...
    cover_image = models.ImageField(upload_to='covers/', null=True, blank=True, help_text="Cover image of the song")  # Yeni alan
...
class LikedSong(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='liked_songs', help_text="User who liked the song")
    song = models.ForeignKey(Song, on_delete=models.CASCADE, related_name='liked_by', help_text="Song liked by the user")
